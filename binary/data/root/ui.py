...
class DragonBoard(Window):
	...
	def __init__(self):
		Window.__init__(self)
		self.MakeBoard("d:/ymir work/ui/interface/dragonetc/Board_Corner_", "d:/ymir work/ui/interface/dragonetc/Board_Line_")
		self.MakeBase()
	...
	def MakeBase(self):
		self.Base = ExpandedImageBox()
		self.Base.AddFlag("not_pick")
		self.Base.LoadImage("d:/ymir work/ui/interface/dragonetc/Board_Base.tga")
		self.Base.SetParent(self)
		self.Base.SetPosition(self.CORNER_WIDTH, self.CORNER_HEIGHT)
		self.Base.Show()
