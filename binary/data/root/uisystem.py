...
class SystemDialog(ui.ScriptWindow):
	...
	def __init__(self):
		...
		# self.zmiana_kanalu = uichannel.Zmiana_Kanalu()
		self.__Initialize()
	...
	def __LoadSystemMenu_Default(self):
		...
		# self.GetChild("zmiana_kanalu").SAFE_SetEvent(self.__ClickZmianaKanalu)
		self.GetChild("movechannel_button").SAFE_SetEvent(self.__ClickZmianaKanalu)
