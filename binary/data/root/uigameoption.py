...
class OptionDialog(ui.ScriptWindow):
	...
	def __Load(self):
		...
		self.MadaraModelShow[0].SetToggleUpEvent(self.__OnClickHideShopsButton)
		self.MadaraModelShow[0].SetToggleDownEvent(self.__OnClickHideShopsButton)	
	...
	def __OnClickHideShopsButton(self):
		import uiPrivateShopBuilder
		systemSetting.SetHideShops(not systemSetting.IsHideShops() and systemSetting.IsShowSalesText())
		if systemSetting.IsHideShops():		
