...
class PrivateShopBuilder(ui.ScriptWindow):
	...
	def AcceptInputPrice(self):
		...
		if app.ENABLE_CHEQUE_SYSTEM:
			...
			if app.PRICE_TYPE:
				if app.SHOP_STOK:
					shop.AddPrivateShopItemStock(attachedInvenType, sourceSlotPos, targetSlotPos, price, chequep,0,0)
				else:
					shop.AddPrivateShopItemStock(attachedInvenType, sourceSlotPos, targetSlotPos, price, chequep,0)
			else:
				if app.SHOP_STOK:
					shop.AddPrivateShopItemStock(attachedInvenType, sourceSlotPos, targetSlotPos, price, chequep,0)
				else:
			...
			if app.PRICE_TYPE:
				if app.SHOP_STOK:
					shop.AddPrivateShopItemStock(attachedInvenType, sourceSlotPos, targetSlotPos, price,0,0)
				else:
					shop.AddPrivateShopItemStock(attachedInvenType, sourceSlotPos, targetSlotPos, price,0)
			else:
				if app.SHOP_STOK:
					shop.AddPrivateShopItemStock(attachedInvenType, sourceSlotPos, targetSlotPos, price,0)
				else:
