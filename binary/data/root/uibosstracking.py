...
MOB_VNUM_LIST = [1192, 2206, 691, 791, 1304, 2492, 2494, 2495, 2091, 3972, 2191, 2306, 1901, 2291]
...
ELEMENT_LIST =  \
{
	...
	MOB_VNUM_LIST[13] : localeInfo.BOSS_TRACKING_ELEMENT_NAME2,
}
...
class BossTrackingInfoWindow(ui.ScriptWindow):
	...
	def OnUpdate(self):
		for key in xrange(len(self.data)):
			...
			if CHANNEL_COUNT < 5:
				self.respawnInfos[6-1].SetText("CH6: Bu kanal açýlmayacaktýr.")
				self.respawnInfos[5-1].SetText("CH5: Bu kanal açýlmayacaktýr.")
