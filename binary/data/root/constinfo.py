...
depolar = 0
ENABLE_DUNGEON_TIMER=1

#### Hızlı Menu System ####
OPEN_SEARCH_SYSTEM = 0
OPEN_NPC_SHOP = 0
OPEN_BOSS_MANAGER = 0
OPEN_KYGN_SYSTEM_OPEN = 0
#### Hızlı Menu System ####
...
if app.ENABLE_SWITCHBOT:
	def CanPutItemInSwitchbot(itemIndex):
		...
		if item.GetItemType() == item.ITEM_TYPE_ARMOR and\
			not item.GetItemSubType() in [item.ARMOR_BODY, item.ARMOR_HEAD, item.ARMOR_SHIELD, item.ARMOR_WRIST, item.ARMOR_FOOTS, item.ARMOR_NECK, item.ARMOR_EAR]:
			return False
