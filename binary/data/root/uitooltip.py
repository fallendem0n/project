...
class ToolTip(ui.ThinBoard):
	...
	SPECIAL_POSITIVE_COLOR3 = grp.GenerateColor(0,1.75,1, 1.0)
	SPECIAL_POSITIVE_COLOR4 = grp.GenerateColor(0.8824, 0.9804, 0.8824, 1.0)
...
class ItemToolTip(ToolTip):
	...
	AFFECT_DICT = {
		item.APPLY_MAX_HP : [localeInfo.TOOLTIP_MAX_HP,2000],
		item.APPLY_MAX_SP : [localeInfo.TOOLTIP_MAX_SP,30],
		...
		item.APPLY_ATT_SPEED : [localeInfo.TOOLTIP_ATT_SPEED,8],
		item.APPLY_MOV_SPEED : [localeInfo.TOOLTIP_MOV_SPEED,20],
		item.APPLY_CAST_SPEED : [localeInfo.TOOLTIP_CAST_SPEED,20],
		...
		item.APPLY_CRITICAL_PCT : [localeInfo.TOOLTIP_APPLY_CRITICAL_PCT,10],
		item.APPLY_PENETRATE_PCT : [localeInfo.TOOLTIP_APPLY_PENETRATE_PCT,10],

		item.APPLY_ATTBONUS_WARRIOR : [localeInfo.TOOLTIP_APPLY_ATTBONUS_WARRIOR,15],
		item.APPLY_ATTBONUS_ASSASSIN : [localeInfo.TOOLTIP_APPLY_ATTBONUS_ASSASSIN,15],
		item.APPLY_ATTBONUS_SURA : [localeInfo.TOOLTIP_APPLY_ATTBONUS_SURA,15],
		item.APPLY_ATTBONUS_SHAMAN : [localeInfo.TOOLTIP_APPLY_ATTBONUS_SHAMAN,15],
		item.APPLY_ATTBONUS_MONSTER : [localeInfo.TOOLTIP_APPLY_ATTBONUS_MONSTER,15],

		item.APPLY_ATTBONUS_HUMAN : [localeInfo.TOOLTIP_APPLY_ATTBONUS_HUMAN,10],
		item.APPLY_ATTBONUS_ANIMAL : [localeInfo.TOOLTIP_APPLY_ATTBONUS_ANIMAL,20],
		item.APPLY_ATTBONUS_ORC : [localeInfo.TOOLTIP_APPLY_ATTBONUS_ORC,20],
		item.APPLY_ATTBONUS_MILGYO : [localeInfo.TOOLTIP_APPLY_ATTBONUS_MILGYO,20],
		item.APPLY_ATTBONUS_UNDEAD : [localeInfo.TOOLTIP_APPLY_ATTBONUS_UNDEAD,20],
		item.APPLY_ATTBONUS_DEVIL : [localeInfo.TOOLTIP_APPLY_ATTBONUS_DEVIL,20],
		item.APPLY_STEAL_HP : [localeInfo.TOOLTIP_APPLY_STEAL_HP,10],
		item.APPLY_STEAL_SP : [localeInfo.TOOLTIP_APPLY_STEAL_SP,10],
		item.APPLY_MANA_BURN_PCT : [localeInfo.TOOLTIP_APPLY_MANA_BURN_PCT,10],
		item.APPLY_DAMAGE_SP_RECOVER : [localeInfo.TOOLTIP_APPLY_DAMAGE_SP_RECOVER,10],
		item.APPLY_BLOCK : [localeInfo.TOOLTIP_APPLY_BLOCK,100],
		item.APPLY_DODGE : [localeInfo.TOOLTIP_APPLY_DODGE,100],
		item.APPLY_RESIST_SWORD : [localeInfo.TOOLTIP_APPLY_RESIST_SWORD,15],
		item.APPLY_RESIST_TWOHAND : [localeInfo.TOOLTIP_APPLY_RESIST_TWOHAND,15],
		item.APPLY_RESIST_DAGGER : [localeInfo.TOOLTIP_APPLY_RESIST_DAGGER,15],
		item.APPLY_RESIST_BELL : [localeInfo.TOOLTIP_APPLY_RESIST_BELL,15],
		item.APPLY_RESIST_FAN : [localeInfo.TOOLTIP_APPLY_RESIST_FAN,15],
		item.APPLY_RESIST_BOW : [localeInfo.TOOLTIP_RESIST_BOW,15],
		item.APPLY_RESIST_FIRE : [localeInfo.TOOLTIP_RESIST_FIRE,15],
		item.APPLY_RESIST_ELEC : [localeInfo.TOOLTIP_RESIST_ELEC,15],
		item.APPLY_RESIST_MAGIC : [localeInfo.TOOLTIP_RESIST_MAGIC,15],
		item.APPLY_RESIST_WIND : [localeInfo.TOOLTIP_APPLY_RESIST_WIND,15],
		item.APPLY_REFLECT_MELEE : [localeInfo.TOOLTIP_APPLY_REFLECT_MELEE,100],
		item.APPLY_REFLECT_CURSE : [localeInfo.TOOLTIP_APPLY_REFLECT_CURSE,100],
		item.APPLY_POISON_REDUCE : [localeInfo.TOOLTIP_APPLY_POISON_REDUCE,100],
		item.APPLY_KILL_SP_RECOVER : [localeInfo.TOOLTIP_APPLY_KILL_SP_RECOVER,100],
		item.APPLY_EXP_DOUBLE_BONUS : [localeInfo.TOOLTIP_APPLY_EXP_DOUBLE_BONUS,20],
		item.APPLY_GOLD_DOUBLE_BONUS : [localeInfo.TOOLTIP_APPLY_GOLD_DOUBLE_BONUS,20],
		item.APPLY_ITEM_DROP_BONUS : [localeInfo.TOOLTIP_APPLY_ITEM_DROP_BONUS,20],
		item.APPLY_POTION_BONUS : [localeInfo.TOOLTIP_APPLY_POTION_BONUS,100],
		item.APPLY_KILL_HP_RECOVER : [localeInfo.TOOLTIP_APPLY_KILL_HP_RECOVER,100],
		item.APPLY_IMMUNE_STUN : [localeInfo.TOOLTIP_APPLY_IMMUNE_STUN,100],
		item.APPLY_IMMUNE_SLOW : [localeInfo.TOOLTIP_APPLY_IMMUNE_SLOW,100],
		item.APPLY_IMMUNE_FALL : [localeInfo.TOOLTIP_APPLY_IMMUNE_FALL,100],
		item.APPLY_BOW_DISTANCE : [localeInfo.TOOLTIP_BOW_DISTANCE,100],
		item.APPLY_DEF_GRADE_BONUS : [localeInfo.TOOLTIP_DEF_GRADE,100],
		item.APPLY_ATT_GRADE_BONUS : [localeInfo.TOOLTIP_ATT_GRADE,100],
		item.APPLY_MAGIC_ATT_GRADE : [localeInfo.TOOLTIP_MAGIC_ATT_GRADE,100],
		item.APPLY_MAGIC_DEF_GRADE : [localeInfo.TOOLTIP_MAGIC_DEF_GRADE,100],
		item.APPLY_MAX_STAMINA : [localeInfo.TOOLTIP_MAX_STAMINA,100],
		item.APPLY_MALL_ATTBONUS : [localeInfo.TOOLTIP_MALL_ATTBONUS,100],
		item.APPLY_MALL_DEFBONUS : [localeInfo.TOOLTIP_MALL_DEFBONUS,100],
		item.APPLY_MALL_EXPBONUS : [localeInfo.TOOLTIP_MALL_EXPBONUS,20],
		item.APPLY_MALL_ITEMBONUS : [localeInfo.TOOLTIP_MALL_ITEMBONUS,20],
		item.APPLY_MALL_GOLDBONUS : [localeInfo.TOOLTIP_MALL_GOLDBONUS,20],
		item.APPLY_SKILL_DAMAGE_BONUS : [localeInfo.TOOLTIP_SKILL_DAMAGE_BONUS,20],
		item.APPLY_NORMAL_HIT_DAMAGE_BONUS : [localeInfo.TOOLTIP_NORMAL_HIT_DAMAGE_BONUS,45],
		item.APPLY_SKILL_DEFEND_BONUS : [localeInfo.TOOLTIP_SKILL_DEFEND_BONUS,100],
		item.APPLY_NORMAL_HIT_DEFEND_BONUS : [localeInfo.TOOLTIP_NORMAL_HIT_DEFEND_BONUS,100],
		item.APPLY_RESIST_WARRIOR : [localeInfo.TOOLTIP_APPLY_RESIST_WARRIOR,100],
		item.APPLY_RESIST_ASSASSIN : [localeInfo.TOOLTIP_APPLY_RESIST_ASSASSIN,100],
		item.APPLY_RESIST_SURA : [localeInfo.TOOLTIP_APPLY_RESIST_SURA,100],
		item.APPLY_RESIST_SHAMAN : [localeInfo.TOOLTIP_APPLY_RESIST_SHAMAN,100],
		item.APPLY_MAX_HP_PCT : [localeInfo.TOOLTIP_APPLY_MAX_HP_PCT,100],
		item.APPLY_MAX_SP_PCT : [localeInfo.TOOLTIP_APPLY_MAX_SP_PCT,100],
		item.APPLY_ENERGY : [localeInfo.TOOLTIP_ENERGY,100],
		item.APPLY_COSTUME_ATTR_BONUS : [localeInfo.TOOLTIP_COSTUME_ATTR_BONUS,100],

		item.APPLY_MAGIC_ATTBONUS_PER : [localeInfo.TOOLTIP_MAGIC_ATTBONUS_PER,100],
		item.APPLY_MELEE_MAGIC_ATTBONUS_PER : [localeInfo.TOOLTIP_MELEE_MAGIC_ATTBONUS_PER,100],
		item.APPLY_RESIST_ICE : [localeInfo.TOOLTIP_RESIST_ICE,100],
		item.APPLY_RESIST_EARTH : [localeInfo.TOOLTIP_RESIST_EARTH,100],
		item.APPLY_RESIST_DARK : [localeInfo.TOOLTIP_RESIST_DARK,100],
		item.APPLY_ANTI_CRITICAL_PCT : [localeInfo.TOOLTIP_ANTI_CRITICAL_PCT,100],
		item.APPLY_ANTI_PENETRATE_PCT : [localeInfo.TOOLTIP_ANTI_PENETRATE_PCT,100],
	}
	if app.ENABLE_WOLFMAN_CHARACTER:
		AFFECT_DICT.update({
	...
	AFFECT_DICT.update({
		item.APPLY_METIN_BONUS : localeInfo.TOOLTIP_ATTBONUS_STONE,
		item.APPLY_BOSS_BONUS : localeInfo.TOOLTIP_ATTBONUS_BOSS,
		item.APPLY_DUNGEON_BONUS : localeInfo.TOOLTIP_ATTBONUS_DUNGEON,
	})
	...
	def SetInventoryItem(self, slotIndex, window_type = player.INVENTORY):
		...
		if app.ENABLE_SHOW_CHEST_DROP:
			...
			if item.GetItemType() == item.ITEM_TYPE_GIFTBOX:
				self.AppendSpace(5)
				self.AppendTextLine("|Eemoji/key_shift|e + |Eemoji/key_rclick|e - Toplu acma ve Sandik Onizleme")
				# self.__SandikIngoru("d:/ymir work/ui/shift+sag.tga")
				# self.AppendTextLine("(Sandik icgoru icin tiklayin.)", self.SPECIAL_POSITIVE_COLOR)
	...
	def SetShopItem(self, slotIndex):
		...
		if app.SHOP_STOK:
			stok = shop.GetItemStok(slotIndex)
		...
		if app.ENABLE_CHEQUE_SYSTEM:
			if shop.IsPrivateShop():
				...
				if cheque > 0:
					self.AppendSpace(5)
					self.AppendTextLine(localeInfo.NumberToWonString(cheque), grp.GenerateColor(0./255, 215./255, 255./255, 1.0))
				if price > 0:
					self.AppendSpace(5)
				...
				if app.SHOP_STOK:
					if stok != 999:
						self.AppendTextLine("Stok : "+str(stok),self.NEGATIVE_COLOR)
	...
	def AppendWon(self, price2):
		self.AppendSpace(5)
		self.AppendTextLine(("Won %d" % (price2)), self.WON_PRICE_COLOR)
	...
	if app.PRICE_TYPE:
		def AppendPriceWithType(self, price, price_type):	
			...
			if price < 1:
				...
				self.AppendTextLineWithItem(localeInfo.TOOLTIP_BUYPRICE  % (localeInfo.NumberToItemString(price, price_type)), price_type,self.GetPriceColor(price))
				
				
		def AppendPriceEP(self, price):	
			self.AppendSpace(5)
			if price < 1:
				self.AppendTextLine("[?retsiz]", self.POSITIVE_COLOR)
			else:
				self.AppendTextLine(localeInfo.TOOLTIP_BUYPRICE  % (localeInfo.NumberToMoneyStringEP(price)), self.HIGH_PRICE_COLOR)
...
// Fonksiyonu de?i?tir - Replace this function
	def __GetAttributeColor(self, index, value, smax =0):
		if value > 0:
			if index >= 5:
				...
				if smax != 0:
					...
					return self.SPECIAL_POSITIVE_COLOR4
		elif value == 0:
			return self.NORMAL_COLOR
		else:
			return self.NEGATIVE_COLOR
	...
	def AddItemData_Offline(self, itemVnum, itemDesc, itemSummary, metinSlot, attrSlot):
		...
		if item.LUCKBOX_VNUM == itemVnum:
			if metinSlot[1] != 0:
				self.AppendSpace(2)
				item.SelectItem(metinSlot[1])
				self.AppendTextLine(localeinfo.LUCKBOX_DESC_NAME+str(item.GetItemName()), self.NEGATIVE_COLOR)
				item.SelectItem(itemVnum)
				self.AppendSpace(2)
			else:
				self.AppendTextLine(localeinfo.LUCKBOX_DESC_NOT_OPEN, self.NEGATIVE_COLOR)
				item.SelectItem(itemVnum)
				self.AppendSpace(2)
			self.AppendTextLine(localeinfo.LUCKBOX_DESC_COUNT + " "+str(5-metinSlot[0]), self.SPECIAL_POSITIVE_COLOR)
			self.ShowToolTip()
			return 
	...
	def AddItemData(self, itemVnum, metinSlot, attrSlot = 0, flags = 0, unbindTime = 0, window_type = player.INVENTORY, slotIndex = -1):
		...
		if app.ENABLE_COSTUME_SYSTEM:
			if item.ITEM_TYPE_COSTUME == itemType:
				...
				if app.ICE_FIRE_RING:
					isCostumeRing = item.ITEM_TYPE_SPECIAL_RING == itemSubType
		...
		if app.ICE_FIRE_RING:
			# if itemVnum == item.ICE_RING or itemVnum == item.FIRE_RING:
				# chat.AppendChat(1,"Y?? do?u type "+str(itemType))
				# chat.AppendChat(1,"clientteki type "+str(item.ITEM_TYPE_SPECIAL_RING))
			if item.ITEM_TYPE_SPECIAL_RING == itemType:
				if itemVnum == item.ICE_RING or itemVnum == item.FIRE_RING:
					ringlv = metinSlot[3]
					current = metinSlot[4]
					neededexp = metinSlot[5]
					xpPerc = (current*100)/neededexp
					
					self.AppendTextLine(localeInfo.RING_LEVEL % (ringlv), self.CONDITION_COLOR)

					if app.IsPressed(app.DIK_LSHIFT):
						self.AppendTextLine(localeInfo.RING_EXP2 +" %" +str(xpPerc) + "("+str(current)+"/"+str(neededexp)+")", self.CONDITION_COLOR)
					else:
						self.AppendTextLine(localeInfo.RING_EXP % (xpPerc), self.CONDITION_COLOR)
						
					self.__AppendLimitInformation()
					self.__AppendAffectInformation()
					self.__AppendAttributeInformation(attrSlot)
						
					self.AppendTextLine(localeInfo.RING_DESC, self.CONDITION_COLOR)
		...
		### Use ###
			...
			if item.USE_SPECIAL == itemSubType:
				if app.ENABLE_EXTENDING_COSTUME_TIME and itemVnum >= 84014 and itemVnum <= 84016:
					self.AppendTextLine(localeInfo.COSTUME_EXTENDING_TOOLTIP % item.GetValue(0), self.SPECIAL_POSITIVE_COLOR)
				bHasRealtimeFlag = 0
				for i in xrange(item.LIMIT_MAX_NUM):
					(limitType, limitValue) = item.GetLimit(i)
