...
import locale
import uiToolTip
import grp, serverInfo
from _weakref import proxy
import mouseModule
import constInfo

import app,shop,player,chat,net,pack
...
class EigenartigSwitchBotDialog(ui.ScriptWindow):
	...
	def AddGui(self):
		Gui = [
		[[ui.BoardWithTitleBar, ""], [253, 393], [0,0], [["SetCenterPosition", [""]], ["SetCloseEvent", [self.__del__]], ["SetTitleName", [serverInfo.SERVER_NAME + " Yeþil Efsun Botu "]]], ["float","movable"]],			
		[[ui.ImageBox, 0], [0, 0], [0, 355], [['LoadImage', ["efsun/tab_1.sub"]]], []],
		]

		for i in xrange(4):
			x =69*i
			button = [[ui.Button, 0], [61, 27], [x, 370], [['SetEvent', [lambda Index = i: self.SelectTab(Index)]]], []]
			Gui.append(button)		
	...
	def StartBOT(self, type):
		...
		if not type:	
			if not self.Cfg[Tab][0]:
				...
				for Slot in xrange(player.INVENTORY_PAGE_SIZE*40):
...
##		
	...
	def __init__(self):
		...
		self.background.LoadImage("yusufwork/switchbot/background_new.png")
		self.background.SetPosition(-23, 115)
		self.background.Show()

		self.background_item = ui.ImageBox()
		self.background_item.SetParent(self)
		self.background_item.LoadImage("yusufwork/switchbot/background_item.png")
		self.background_item.SetPosition(-23, 0)
		...
		self.gridSlowWind.SetPosition(1,4)
		self.gridSlowWind.ArrangeSlot(0, 1, 3, 32, 32, 0, 0)
		self.gridSlowWind.SetSlotBaseImage("yusufwork/switch_slot2.png", 1.0, 1.0, 1.0, 1.0)
		...
		self.background2 = ui.Board()
		self.background2.SetParent(self)
		self.background2.SetSize(253,390)
		self.background2.SetPosition(222, -40)
		self.background2.Hide()

		self.background_tooltip = ui.ImageBox()
		self.background_tooltip.SetParent(self.background2)
		self.background_tooltip.LoadImage("yusufwork/switchbot/tooltip_back.png")
		self.background_tooltip.SetPosition(5, 5)
		self.background_tooltip.Show()


		self.itemToolTip = ToolTipWithoutMetins()
		self.itemToolTip.SetPosition(18, 30)
		self.itemToolTip.SetParent(self.background_tooltip)
		...
		self.delete_bonus.SetUpVisual("d:/ymir work/ui/switchbot/buttons/reset_switch_norm.tga")
		self.delete_bonus.SetOverVisual("d:/ymir work/ui/switchbot/buttons/reset_switch_hover.tga")
		self.delete_bonus.SetDownVisual("d:/ymir work/ui/switchbot/buttons/reset_switch_down.tga")

		self.delete_bonus.SetText("Temizle")
		self.delete_bonus.SetPosition(0, 265)
		...
		self.norm_bonus.SetUpVisual("d:/ymir work/ui/switchbot/buttons/start_switch_norm.tga")
		self.norm_bonus.SetOverVisual("d:/ymir work/ui/switchbot/buttons/start_switch_hover.tga")
		self.norm_bonus.SetDownVisual("d:/ymir work/ui/switchbot/buttons/start_switch_down.tga")
		self.norm_bonus.SetText("Baþlat")
		self.norm_bonus.SetPosition(98, 265)
		...
		self.six_seven_bonus.SetUpVisual("d:/ymir work/ui/switchbot/buttons/start_switch_norm.tga")
		self.six_seven_bonus.SetOverVisual("d:/ymir work/ui/switchbot/buttons/start_switch_hover.tga")
		self.six_seven_bonus.SetDownVisual("d:/ymir work/ui/switchbot/buttons/start_switch_down.tga")
		...
		for i in xrange(5):
			...
			selectBonus.SetSize(140, 18)
			selectBonus.SetPosition(0, yPos + 143)
			...
			slotBar.SetParent(self)
			slotBar.SetSize(42, 18)
			slotBar.SetPosition(155, y_Pos + 143)
			slotBar.Show()
