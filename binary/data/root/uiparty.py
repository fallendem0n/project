...
class PartyMemberInfoBoard(ui.ScriptWindow):
	...
	def __LoadBoard(self):
		...
		try:
			...
			self.poisonGauge = self.GetChild("PoisonGauge") ##yeşil bar
		...
		self.poisonGauge.Hide() ##yeşil bar
	...
	def SetCharacterHP(self, hpPercentage):
		...
		self.poisonGauge.SetPercentage(hpPercentage, 100) ## yeşil bar
