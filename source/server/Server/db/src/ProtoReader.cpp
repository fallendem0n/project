...
int get_Item_SubType_Value(unsigned int type_value, string inputString)
{
	...
	static string arSub14[] = { "RESOURCE_FISHBONE", "RESOURCE_WATERSTONEPIECE", "RESOURCE_WATERSTONE", "RESOURCE_BLOOD_PEARL",
						...
						"RESOURCE_STONE", "RESOURCE_METIN", "RESOURCE_ORE", "RESOURCE_GREEN_PEARL", "RESOURCE_PINK_PEARL", "RESOURCE_GOLD_PEARL" };
	...
	static string arSub35[] = { "PET_NORMAL", "PET_MALL" };
#ifdef ICE_FIRE_RING
	static string arSub39[] = { "RING_FIRE", "RING_ICE" };
#endif
	...
	static string* arSubType[] = { 0,	//0
		...
		0,			//35
#endif
#ifdef ENABLE_PET_SYSTEM_RENEWAL
		arSub35,
#else
		0,			//36
#endif
