...
#ifdef ICE_FIRE_RING
extern const DWORD	FireRingAttrTable[2][3];
extern const DWORD	FireRingExpTable[21];
extern const DWORD	IceRingAttrTable[2][3];
extern const DWORD	IceRingExpTable[21];
#endif
...
extern const DWORD		BiyologSistemi[11][16];
#endif
#endif
