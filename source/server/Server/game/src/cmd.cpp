...
#ifdef ENABLE_QUEST_WINDOW_DAMAGE_SYSTEM
	{ "quest_is_dialog",			do_quest_is_dialog,		0,	POS_DEAD,	GM_PLAYER	},
#endif
...
#ifdef BLACKMARKET
	{ "blackmarket_getlist",	do_blackmarket_getlist,	0,	POS_DEAD,	GM_PLAYER	},
#endif
...
#endif
#ifdef OPEN_COMMAND_OFFLINESHOP
	{ "azar_ac",	do_azar_ac,	0,	POS_DEAD,	GM_IMPLEMENTOR	},
#endif
#ifdef ENABLE_PM_ALL_SEND_SYSTEM
...
#ifdef ENABLE_BASLANGIC_SYSTEM
	{ "selam_itemver",            do_selam_itemver,            0,    POS_DEAD,    GM_PLAYER        },
	{ "selam_efsunver",        do_selam_efsunver,        0,    POS_DEAD,    GM_PLAYER        },
#endif
...
#ifdef NEW_SALES_SYSTEM	
	{ "sales_list",		do_sales_list,		0,			POS_DEAD,		GM_PLAYER		},
	{ "sales_buy",		do_sales_buy,		0,			POS_DEAD,		GM_PLAYER		},
#endif

#ifdef LUCK_BOX
	{ "luckboxgetreward",	do_luckboxgetreward,	0,	POS_DEAD,	GM_PLAYER	},
	{ "luckboxchangereward",	do_luckboxchangereward,	0,	POS_DEAD,	GM_PLAYER	},
#endif
...
#endif
#ifdef KYGN_ITEM_REMOVE
	{ "add_remove_item_index",	do_add_remove_item_index,	0,	POS_DEAD,	GM_PLAYER	},
	{ "remove_item_system_button",	do_remove_item_system_button,	0,	POS_DEAD,	GM_PLAYER	},
	{ "remove_item_system_close",	do_remove_item_system_close,	0,	POS_DEAD,	GM_PLAYER	},
#endif
#ifdef ENABLE_RONARK_SYSTEM
	{ "ronark",	do_ronark,	0,	POS_DEAD,	GM_PLAYER	},
#endif
