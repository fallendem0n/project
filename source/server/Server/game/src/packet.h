...
//	HEADER_CG_RUNUP_MATRIX_ANSWER	= 201,
	...
	HEADER_CG_TARGET_INFO_LOAD				= 207,
#endif
	// HEADER_BURASI_DOLU_LANNN				= 208,
#ifdef ENABLE_PM_ALL_SEND_SYSTEM
	HEADER_CG_BULK_WHISPER					= 209,
#endif
#ifdef ENABLE_ITEM_YOKET_SYSTEM
	HEADER_CG_ITEM_DESTROY					= 210,
#endif
	// HEADER_BURASI_DOLU_LANNN				= 211,
#ifdef ENABLE_SORT_INVEN
	SORT_INVEN								= 212,
#endif

#ifdef BLACKMARKET
    HEADER_CG_BLACKMARKET		= 213,
#endif
...
#ifdef __ENABLE_NEW_OFFLINESHOP__
	HEADER_GC_NEW_OFFLINESHOP				= 220,
#endif
#ifdef ENABLE_TARGET_INFORMATION_SYSTEM
	HEADER_GC_TARGET_INFO					= 211,
#endif
...
#ifdef LUCK_BOX
	HEADER_GG_LUCKBOX					= 44,
#endif
#ifdef ENABLE_FULL_NOTICE
	HEADER_GG_BIG_NOTICE							= 30,
#endif
#ifdef ENABLE_BOSS_MANAGER_SYSTEM
	HEADER_GG_BOSS_DATA								= 31,
#endif
#ifdef ENABLE_OFFLINESHOP_MESSAGE_SYSTEM
	HEADER_GG_OFFLINE_SHOP_SEND_MESSAGE				= 32,
#endif
#ifdef ENABLE_RONARK_SYSTEM
	HEADER_GG_RONARKSORGU = 33, //33 sizde varsa olmayan bi sayi yazin
#endif
#ifdef ENABLE_PM_ALL_SEND_SYSTEM
	HEADER_GG_BULK_WHISPER							= 38,
#endif
#ifdef BLACKMARKET
	HEADER_GG_BLACKMARKET					= 39,
#endif
#ifdef NEW_SALES_SYSTEM
	HEADER_GG_SALES					= 40,
#endif
#ifdef ENABLE_SWITCHBOT
	HEADER_GG_SWITCHBOT = 41,
#endif
};
...
#ifdef ENABLE_RONARK_SYSTEM
typedef struct SPacketGGRonarkSorgu
{
	BYTE	bHeader;
	long	lSize;
} TPacketGGRonarkSorgu;
#endif
...
#ifdef BLACKMARKET
typedef struct command_item_blackmarket
{
    BYTE        header;
    TItemPos    Cell;
} TPacketCGItemBlackMarket;
#endif


#ifdef NEW_SALES_SYSTEM
typedef struct SPacketSales
{
	BYTE    bHeader;
} TPacketGGSales;
#endif
...
#endif
#ifdef PRICE_TYPE
	SHOP_SUBHEADER_GC_NOT_ENOUGH_MONEY_EX_EP,
	SHOP_SUBHEADER_GC_NOT_ENOUGH_ITEM,
#endif
#ifdef SHOP_STOK
	SHOP_SUBHEADER_GC_STOK,
#endif
};
...
#ifdef BLACKMARKET
typedef struct SPacketBlackMarket
{
	BYTE    bHeader;
} TPacketGGBlackMarket;
#endif
