...
#endif
#ifdef BLACKMARKET
	Set(HEADER_CG_BLACKMARKET, sizeof(TPacketCGItemBlackMarket), "BlackMarket", true);
#endif
...
CPacketInfoGG::CPacketInfoGG()
{
	...
	Set(HEADER_GG_RONARKSORGU,		sizeof(TPacketGGRonarkSorgu),	"SendRonarkNot", false);
#endif
...
#ifdef BLACKMARKET
	Set(HEADER_GG_BLACKMARKET,				sizeof(TPacketGGBlackMarket), "BlackMarket",false);
#endif

#ifdef LUCK_BOX
	Set(HEADER_GG_LUCKBOX,				sizeof(TPacketGGLuckBox), "LuckBox",false);
#endif

#ifdef NEW_SALES_SYSTEM
	Set(HEADER_GG_SALES,				sizeof(TPacketGGSales), "Sales",false);
#endif
