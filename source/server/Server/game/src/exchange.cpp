...
bool CExchange::CheckSpace()
{
	...
	static CGrid s_upp_grid1(INVENTORY_PAGE_COLUMN, INVENTORY_PAGE_ROW);
	static CGrid s_upp_grid2(INVENTORY_PAGE_COLUMN, INVENTORY_PAGE_ROW);
	static CGrid s_book_grid1(INVENTORY_PAGE_COLUMN, INVENTORY_PAGE_ROW);
	static CGrid s_book_grid2(INVENTORY_PAGE_COLUMN, INVENTORY_PAGE_ROW);
	static CGrid s_stone_grid1(INVENTORY_PAGE_COLUMN, INVENTORY_PAGE_ROW);
	static CGrid s_stone_grid2(INVENTORY_PAGE_COLUMN, INVENTORY_PAGE_ROW);
	s_upp_grid1.Clear();
	s_upp_grid2.Clear();
	s_book_grid1.Clear();
	s_book_grid2.Clear();
	...
	for (int i = 0; i < SPECIAL_INVENTORY_MAX_NUM; ++i)
	{
		...
		if (i < SPECIAL_INVENTORY_MAX_NUM / SPECIAL_INVENTORY_PAGE_COUNT)
		{
	...
	for (i = 0; i < EXCHANGE_ITEM_MAX_NUM; ++i)
	{
		...
		{
			if (upgde_cnt == SPECIAL_INVENTORY_MAX_NUM)
				return false;
		...
		{
			if (book_cnt == SPECIAL_INVENTORY_MAX_NUM)
				return false;
		...
		{
			if (stne_cnt == SPECIAL_INVENTORY_MAX_NUM)
				return false;
