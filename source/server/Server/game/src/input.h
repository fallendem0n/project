...
#endif
#ifdef BLACKMARKET
		void        BlackMarket(LPCHARACTER ch, const char * data);
#endif
...
class CInputP2P : public CInputProcessor
{
	...
	void		Switchbot(LPDESC d, const char* c_pData);
		...
		int			SendRonarkNot(LPDESC d, const char * c_pData, size_t uiBytes);
#endif
...
#endif
#ifdef BLACKMARKET
		void		BlackMarket(const char * c_pData);
#endif
...
#ifdef LUCK_BOX
		void		LuckBox(const char * c_pData);
#endif
