...
class CGuild
{
	public:
		...
		bool		GetRonarkLoncaIcerdeMi() { return ronark_lonca_icerdemi; }
		void		SetRonarkLoncaIcerdeMi(bool value) { ronark_lonca_icerdemi = value; }
		BYTE		GetRonarkOnline() { return ronark_online; }
		void		SetRonarkOnline(BYTE value) { ronark_online = value; }
#endif
