...
enum EOfflineShop
{
	OFFLINESHOP_DURATION_MAX_MINUTES	= 7 * 24 * 60,//7gun
...
const DWORD dwSwitchingPendantItem[2] = {90040, 90014}; //Feiti?os para talism?s
const DWORD dwSwitchingCostumeItem = 90025;

const DWORD c_arSwitchingLowItens[2] = //Rodares verdes
{
	76023,
	71151,
};
const DWORD c_arSwitchingItems[3] = //Rodares normais
{
	76014,
	39028,
	71084,
