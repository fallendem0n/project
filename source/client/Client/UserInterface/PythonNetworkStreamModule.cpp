...
#ifdef BLACKMARKET
PyObject* netSendItemBlackMarketPacket(PyObject* poSelf, PyObject* poArgs)
{
	TItemPos Cell;
	...
	CPythonNetworkStream& rkNetStream = CPythonNetworkStream::Instance();
	rkNetStream.SendItemBlackMarketPacket(Cell);
	return Py_BuildNone();
}
#endif
...
#ifdef BLACKMARKET
		{ "SendItemBlackMarketPacket",                netSendItemBlackMarketPacket,                METH_VARARGS },
#endif
