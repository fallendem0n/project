...
#ifdef ICE_FIRE_RING
	PyModule_AddIntConstant(poModule, "FIRE_RING", 86200);
	PyModule_AddIntConstant(poModule, "ICE_RING", 86201);
	PyModule_AddIntConstant(poModule, "ITEM_TYPE_SPECIAL_RING", CItemData::ITEM_TYPE_SPECIAL_RING);
	PyModule_AddIntConstant(poModule, "SPECIAL_FIRE_RING", c_Special_Ring_Fire);
	PyModule_AddIntConstant(poModule, "SPECIAL_ICE_RING", c_Special_Ring_Ice);
	PyModule_AddIntConstant(poModule, "RING_FIRE",		CItemData::RING_FIRE);
	PyModule_AddIntConstant(poModule, "RING_ICE",		CItemData::RING_ICE);
#endif

#ifdef LUCK_BOX
	PyModule_AddIntConstant(poModule, "LUCKBOX_VNUM", 71625);
	PyModule_AddIntConstant(poModule, "LUCKBOX_CHANGER", 71624);
#endif
...
#endif
	PyModule_AddIntConstant(poModule, "APPLY_METIN_BONUS",		CItemData::APPLY_METIN_BONUS);
	PyModule_AddIntConstant(poModule, "APPLY_BOSS_BONUS",		CItemData::APPLY_BOSS_BONUS);
	PyModule_AddIntConstant(poModule, "APPLY_DUNGEON_BONUS",		CItemData::APPLY_DUNGEON_BONUS);
