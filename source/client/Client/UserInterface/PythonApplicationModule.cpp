...
void initapp()
{
...
#ifdef ICE_FIRE_RING
	PyModule_AddIntConstant(poModule, "ICE_FIRE_RING", 1);
#else
	PyModule_AddIntConstant(poModule, "ICE_FIRE_RING", 0);
#endif

#ifdef BLACKMARKET
	PyModule_AddIntConstant(poModule, "BLACKMARKET", 1);
#else
	PyModule_AddIntConstant(poModule, "BLACKMARKET", 0);
#endif

#ifdef PRICE_TYPE
	PyModule_AddIntConstant(poModule, "PRICE_TYPE", 1);
#else
	PyModule_AddIntConstant(poModule, "PRICE_TYPE", 0);
#endif

#ifdef SHOP_STOK
	PyModule_AddIntConstant(poModule, "SHOP_STOK", 1);
#else
	PyModule_AddIntConstant(poModule, "SHOP_STOK", 0);
#endif
...
#ifdef LUCK_BOX
	PyModule_AddIntConstant(poModule, "LUCK_BOX", 1);
#else
	PyModule_AddIntConstant(poModule, "LUCK_BOX", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "NEW_SALES_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "NEW_SALES_SYSTEM", 0);
#endif

#ifdef ENABLE_FAST_CHEST_OPEN
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_CHEST_OPEN", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_CHEST_OPEN", 0);
#endif

#ifdef ENABLE_TARGET_HP_SYSTEM
	PyModule_AddIntConstant(poModule, "ENABLE_TARGET_HP_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TARGET_HP_SYSTEM",	0);
#endif

#ifdef WJ_ELDER_ATTRIBUTE_SYSTEM
	PyModule_AddIntConstant(poModule, "WJ_ELDER_ATTRIBUTE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_ELDER_ATTRIBUTE_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SHOPNAMES_RANGE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOPNAMES_RANGE", 0);
#endif
...
#ifdef AUTO_SHOUT
	PyModule_AddIntConstant(poModule, "AUTO_SHOUT", 1);
#else
	PyModule_AddIntConstant(poModule, "AUTO_SHOUT", 0);
#endif
