...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
...
#ifdef BLACKMARKET
		bool SendItemBlackMarketPacket(TItemPos pos);
#endif
	...
	public:
		...
		bool SendSwitchbotStartPacket(BYTE slot, BYTE bBotSpeed,  std::vector<CPythonSwitchbot::TSwitchbotAttributeAlternativeTable> alternatives);
