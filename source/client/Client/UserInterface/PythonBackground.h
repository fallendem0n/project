...
public:
	...
	void CreateTargetEffectShop(DWORD dwID, DWORD dwChrVID);
	void CreateTargetEffectShop(DWORD dwID, long lx, long ly);
#endif
...
#if defined(ENABLE_SHOP_SEARCH)
	std::map<DWORD, DWORD> m_kMap_dwTargetID_dwChrShopID;
#endif
